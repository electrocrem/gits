...
| Wallpaper | awww: `gits-wall --pick` (also in Super+I → Wallpaper) chooses from `~/.local/share/gits/wallpapers` and `~/Pictures/wallpapers`; PNG, JPEG, WebP and **animated GIF** (about 2% of one core); the choice survives logins. No GIFs are shipped: copyright |
