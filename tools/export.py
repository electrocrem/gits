...
MANIFEST = [
    ...
    (".local/bin/gits-vol", None),
    (".local/bin/gits-bright", None),
    (".local/bin/gits-shot", None),
    (".local/bin/gits-logout", None),
    (".local/bin/gits-sysmon", None),
    (".local/bin/gits-project", None),
    (".local/bin/gits-focus", None),
    (".local/bin/gits-note", None),
    (".local/bin/gits-daynight", None),
