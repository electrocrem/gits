...
Logseq, Qt/Dolphin (Kvantum), сборщик темы Telegram, обои через awww (`gits-wall --pick`, в том числе анимированные GIF, примерно 2-5% одного ядра и 20-100 МБ в зависимости от петли; выбор запоминается), а также `gits-doctor` — отчёт о состоянии системы и опциональная настройка снапшотов btrfs.
